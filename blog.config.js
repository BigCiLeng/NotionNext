...
const BLOG = {
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://raw.githubusercontent.com/BigCiLeng/picgo_photos/main/img/favicon11.ico', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
